...
async function createTestBillTable2() {
  try {
    console.log('\n========================================');
    console.log('Creating Test Bill for Table 2');
    console.log('========================================\n');
    ...
    // Create a test bill for table 2 with different items
    const bill = new Bill({
    ...
    console.log('✅ Test bill for Table 2 created successfully!\n');
    ...
    console.log(`https://preview-10skelzj.ui.pythagora.ai/pay?restaurant=${restaurant._id}&table=2\n`);
